#!/usr/bin/env python
"""Run the FoG-STAR MLP window-length sweep sequentially."""
...
CONFIGS = [
    REPO_ROOT / "configs" / "fogstar_mlp_loso_win0p5s_prefog0p5.yaml",
    REPO_ROOT / "configs" / "fogstar_mlp_loso_win1s_prefog0p5.yaml",
    REPO_ROOT / "configs" / "fogstar_mlp_loso_win1p5s_prefog0p5.yaml",
]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run FoG-STAR MLP LOSO configs: window 0.5, 1, 1.5 seconds with Pre-FOG 0.5 seconds.",
    ...
    parser.add_argument(
        "--summary-csv",
        type=Path,
        default=Path("outputs/fogstar_mlp_window_sweep_prefog0p5_summary.csv"),
    )
    parser.add_argument(
        "--summary-json",
        type=Path,
        default=Path("outputs/fogstar_mlp_window_sweep_prefog0p5_summary.json"),
    )

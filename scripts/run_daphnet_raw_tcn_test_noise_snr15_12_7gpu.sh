...
# Additional SNR15/SNR12 evaluation only: 30 inference jobs, no retraining.
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PWD/outputs/daphnet_64Hz_raw_tcn_lr3e-3_wd1e-3_batch128_ep5pat2_test_noise_snr15_12_seedset_0_52_161_5216_52161}"

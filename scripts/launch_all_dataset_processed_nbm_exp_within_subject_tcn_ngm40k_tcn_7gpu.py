#!/usr/bin/env python
"""Launch 120 within-subject 40k TCN-NGM+TCN jobs on seven GPUs."""
...
from scripts.run_all_dataset_processed_nbm_exp_within_subject_tcn_ngm40k_tcn import (
    EXPERIMENT_SCHEMA,
    NBM_PARAMETER_COUNT,
    NBM_VARIANT,
    SUBJECTS,
...
WORKER = (
    REPO_ROOT
    / "scripts"
    / "run_all_dataset_processed_nbm_exp_within_subject_tcn_ngm40k_tcn.py"
)
DEFAULT_EXPERIMENT = (
    "all_dataset_processed_NBM_Exp_within_subject_tcn_ngm40k_mask4_8_C_tcn_"

...
from . import channel_subset_npz_dataset, npz_dataset  # noqa: F401, ensure registration
...
def build_dataloaders(cfg):
    ...
    distributed = bool(cfg.get("runtime", {}).get("distributed", False))
    train_sampler = DistributedSampler(train_set, shuffle=True, drop_last=False) if distributed else None
    return {
        "train": DataLoader(train_set, shuffle=train_sampler is None, sampler=train_sampler, drop_last=False, **common),

#!/usr/bin/env python
"""Launch the processed_NBM_Exp 43k Transformer-NGM+TCN suite on eight GPUs."""
...
from scripts.run_all_dataset_processed_nbm_exp_within_subject_transformer_ngm_43k_tcn import (
    EVENT_AGGREGATION,
...
WORKER = (
    REPO_ROOT
    / "scripts"
    / "run_all_dataset_processed_nbm_exp_within_subject_transformer_ngm_43k_tcn.py"
)
DEFAULT_EXPERIMENT = (
    "all_dataset_processed_NBM_Exp_within_subject_transformer_ngm_43k_global_z16_"
    "C_tcn_nbm300pat20_ep5pat2_seedset_0_52_161_5216_52161"
)
CRITICAL_CODE = (
    WORKER,
...
def build_plan(args: argparse.Namespace, seeds: tuple[int, ...]) -> dict[str, Any]:
    ...
    plan: dict[str, Any] = {
        ...
        "normal_gait_model_parameter_count": NBM_PARAMETER_COUNT,
        ...
        "role_contract": {
            "scaler_and_ngm_fit": [4],
            "ngm_checkpoint_and_residual_scale_calibration": [5],
...
def main() -> None:
    ...
    print(
        ...
        f"transformer_params={NBM_PARAMETER_COUNT}",
        flush=True,
    )
    if args.dry_run:

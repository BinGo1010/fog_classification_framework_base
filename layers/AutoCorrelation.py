...
class AutoCorrelation(nn.Module):
    ...
    def forward(self, queries, keys, values, attn_mask):
        ...
        # cuFFT requires power-of-two signal lengths for FP16 FFT. Keep AMP
        # enabled elsewhere, but run the FFT path in FP32 for arbitrary windows.
        with torch.amp.autocast(device_type=queries.device.type, enabled=False):
